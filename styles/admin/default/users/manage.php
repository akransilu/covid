...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">User Type <span class="required">*</span></label>

                <div class="col-sm-10">    
                    <select name="user_role_id">
                        <?php foreach ($roles as $role): ?>
                            <option value="<?php echo $role->user_role_id ?>"
                            <?php if($role->user_role_id === $item->user_role_id) echo 'selected'; ?>><?php echo $role->role ?></option>           
                        <?php endforeach ?>
                    </select>   
                </div>
            </div>
